...
const int SPIN_180_MS     = 1700;
const int POST_UTURN_BACK = 1000; // ms — reverse after U-turn to clear the rear wall
...
// ---------------------------------------------------------------
// NUDGE BACK — reverse briefly after a U-turn to clear rear wall
// ---------------------------------------------------------------
...
// turnAround — nudge, creep to front, 180, nudge back, then nudge out
